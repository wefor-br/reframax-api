...
import { Usuario, Login, Token } from './usuario.dto';
...
export class SegurancaController {
    ...
    @Post('login')
    @ApiResponse({status : 201, description: 'Login efetuado com sucesso', type: Token})
    ...
    @ApiResponse({status : 200, description: 'Informações do usuário retornadas com sucesso', type: Usuario})
